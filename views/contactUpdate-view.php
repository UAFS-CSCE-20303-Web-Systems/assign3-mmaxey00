            ...
            <div class="col">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">Enter the user Id you wish to update:</p>
                        <form action="contactUpdateController.php" method="POST">
                            <label for="contactid" class="form-label">Contact Id</label>
                            <input type="text" class="form-control mb-3" id="contactid" name="contactid" placeholder="Contact ID to update" required>
